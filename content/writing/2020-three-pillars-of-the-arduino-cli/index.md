...
draft: false
tags: ["golang", "arduino"]
slug: "three-pillars-of-the-arduino-cli"
---
...
{{< figure src="arduino-cli-home.png" title="Arduino CLI help page" width="100%">}}
...
{{< figure src="arduino-cli-core.png" title="Arduino CLI core management" width="100%">}}
...
{{< figure src="arduino-cli-version-json.png" title="Arduino CLI version, JSON format" width="100%">}}
...
{{< figure src="arduino-cli-main.png" title="gRPC client example" width="100%">}}
...
{{< figure src="arduino-cli-embed.png" title="Arduino CLI embedding example" width="100%">}}
